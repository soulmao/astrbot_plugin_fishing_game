...
.grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:8px}.card{min-width:0;padding:11px;border:1px solid #c9e4f1;border-radius:12px;background:linear-gradient(145deg,#f5fbfe,#fff);box-shadow:0 4px 12px rgba(41,128,169,.07)}.card.unaffordable{background:#fbfcfd;opacity:.72}
.card-head{display:flex;align-items:flex-start;justify-content:space-between;gap:9px}.index{display:inline-flex;align-items:center;justify-content:center;min-width:26px;height:26px;border-radius:8px;background:#dff2fc;color:#126c9e;font-weight:900;font-size:12px}.type{padding:2px 6px;border-radius:999px;background:#eef7fb;color:#577482;font-size:10px;font-weight:800}
