...
👻 **特殊前缀钓竿：**
神秘的词缀，拥有独特机制：
• 💰 贪婪的 - 【全部或一无所有】：钓上鱼后形成【贪欲结晶】。可 /收杆 结算，或 /贪婪 继续提高倍率；断线会清空结晶并扣除 10% 当前金币。初始消耗 2 个鱼饵，结算后冷却延长 15%。
• ♾️ 无尽贪婪的 - 更高风险的贪婪版本：首轮断线率更高、成长更快，返回文本会被打乱。初始消耗 3 个鱼饵，结算后冷却延长 30%。可用 `/切换贪婪` 切换，消耗 1000 金币
• 👻 诅咒的 - 附魔和升级仅需正常价格的 35%，但每次钓鱼有 8% 概率丢失一个附魔词条
• ⚡ 迅捷的 - 冷却缩短 45%，20% 概率免冷却，但有 18% 概率失误
• 📚 学徒的 - 经验收益显著提高，但寻宝金币收益降低 35%
• 🎲 幸运方块的 - 随机获得或失去技能，最多保留 6 个附魔技能
