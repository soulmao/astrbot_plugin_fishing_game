...
[![Version](https://img.shields.io/badge/version-V4.5.0-green)]()
...
| 无尽贪婪的 | ♾️ | 首层享 1.4 倍收益，后续倍率成长更快、断线率更高；初始消耗 3 个鱼饵，附魔词条仅首次激活生效，结算冷却 +30%。可通过 `/切换贪婪` 切换 |
...
| 💰 金币钓竿 | 不消耗鱼饵，每次固定消耗 10 金币，自带 15% 寻宝；金币越多，高品质鱼概率越高（最多 +50% 稀有度权重） |
...
默认数值模拟会对普通基准、全部特殊前缀、金币钓竿和胡萝卜钓竿各执行 1000 轮，并报告净价值、单位时间收益、经验和贪婪断线次数。
